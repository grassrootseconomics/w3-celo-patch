> ⚠️ This "fork" is an attempt to patch Celo types to the original [w3](https://github.com/lmittmann/w3) library. Celo introduces breaking Transactions and Block types. Some tests are supressed. Proceed with caution, not everything may work.
...
[![Latest Release](https://img.shields.io/github/v/grassrootseconomics/w3-celo-patch/w3)](https://github.com/grassrootseconomics/w3-celo-patch/releases)
...
`w3` is closely linked to [go-ethereum](https://github.com/celo-org/celo-blockchain)
...
2. Create a signed transaction to the contract using [go-ethereum/types](https://github.com/celo-org/celo-blockchain).
...
[go-ethereum/common](https://pkg.go.dev/github.com/celo-org/celo-blockchain/common)
