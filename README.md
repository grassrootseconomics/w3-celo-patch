> This "fork" is an attempt to patch Celo types to the original [w3](https://github.com/lmittmann/w3) library. Celo introduces breaking Transactions and Block types. Some tests are supressed
